...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LD3320_RST_Pin|LD3320_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD3320_RST_Pin LD3320_CS_Pin */
  GPIO_InitStruct.Pin = LD3320_RST_Pin|LD3320_CS_Pin;
